...
const CATALOG = [
  ...
  { slug: 'lessons',       label: 'Tutoring Classes',               description: 'Tutoria EN/PT',                                                         hourly_usd: 50,  min_hours: 1, step_hours: 0.5, default_hours: 1, mode: 'remote',    active: true, color_accent: 'peach', sort_order: 80, calendar_url: '' },
