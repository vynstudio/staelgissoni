...
const CATALOG = [
  ...
  { slug: 'educational',   label: 'Educational interpretation',     description: 'Interpretação educacional — sala de aula, reuniões de pais e mestres', hourly_usd: 55,  min_hours: 2, step_hours: 0.5, default_hours: 2, mode: 'either',    active: true, color_accent: 'mint',  sort_order: 40, calendar_url: '' },
  { slug: 'conference',    label: 'Conference interpretation',      description: 'Conferências',                                                          hourly_usd: 100, min_hours: 1, step_hours: 0.5, default_hours: 1, mode: 'either',    active: true, color_accent: 'blue',  sort_order: 50, calendar_url: '' },
  ...
  { slug: 'lessons',       label: 'Conversation EN/PT',             description: 'Conversação EN/PT',                                                     hourly_usd: 50,  min_hours: 1, step_hours: 0.5, default_hours: 1, mode: 'remote',    active: true, color_accent: 'peach', sort_order: 80, calendar_url: '' },
